      ...
      createElement(
        ...
        logo
          ...
          : createElement(
              ...
              {
                className:
                  'flex h-8 w-8 items-center justify-center rounded-lg bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 font-bold text-sm',
              },
          ...
          nav.map((item) =>
            createElement(
              'a',
              {
                ...
                href: item.link,
                className:
                  'text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100',
              },
              item.text
            )
          )
      ...
      onSearchOpen &&
        createElement(
          ...
          createElement(
            ...
            {
              className:
                'hidden md:inline ml-4 px-1.5 py-0.5 text-xs rounded bg-zinc-200 dark:bg-zinc-700',
            },
            '⌘K'
          )
        ),
