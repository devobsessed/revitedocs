...
export function Header({
  ...
  return createElement('header', {
    className: cn(
      'sticky top-0 z-50 w-full border-b bg-white/95 dark:bg-gray-900/95 backdrop-blur',
    ...
    createElement('div', { className: 'flex h-14 items-center px-4 md:px-6' },
      ...
      onMenuToggle && createElement('button', {
        ...
        className: 'mr-2 p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 md:hidden',
      ...
      onSearchOpen && createElement('button', {
        ...
        className: cn(
          'flex items-center h-9 px-3 rounded-md border',
        ...
        createElement('kbd', {
          className: 'hidden md:inline ml-4 px-1.5 py-0.5 text-xs rounded bg-gray-200 dark:bg-gray-700',
        }, '⌘K')
      ),
